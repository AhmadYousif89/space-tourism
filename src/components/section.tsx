...
> = ({ children, className = '', header }) => {
  ...
  return (
    <section
      className={`${className} h-screen grid justify-items-center grid-rows-[minmax(50px,100px)_auto_1fr] ws:grid-rows-[minmax(20px,50px)_auto] gap-y-16 pt-40 pb-20 mx-auto md:pt-56 ws:w-[112rem] ws:grid-cols-2 ws:pb-0`}>
